...
namespace ShrimpPond.Persistence.Migrations
{
    ...
    [Migration("20240728082630_updatefeeding3")]
    partial class updatefeeding3
    {
            ...
            modelBuilder.Entity("ShrimpPond.Domain.PondData.Feeding.Food.FoodForFeeding", b =>
                {
                    ...
                    b.Property<int?>("FoodFeedingFeedingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FoodFeedingFeedingId");
            ...
            modelBuilder.Entity("ShrimpPond.Domain.PondData.Feeding.Food.FoodForFeeding", b =>
                {
                    b.HasOne("ShrimpPond.Domain.PondData.Feeding.Food.FoodFeeding", null)
                        .WithMany("Foods")
                        .HasForeignKey("FoodFeedingFeedingId");
                });
