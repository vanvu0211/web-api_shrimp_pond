...
{
    public class FeedingRepository: RepositoryBase<Feeding, int>, IFeedingRepository
    {
        public FeedingRepository(ShrimpPondDbContext shrimpPondDbContext) : base(shrimpPondDbContext)
        {
