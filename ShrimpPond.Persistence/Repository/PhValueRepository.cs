...
{
    public class PhValueRepository : RepositoryBase<PHValue, int>, IPhValueRepository
    {
        public PhValueRepository(ShrimpPondDbContext shrimpPondDbContext) : base(shrimpPondDbContext)
        {
