...
{
    public class NurseryPondRepository: RepositoryBase<NurseryPond, string>, INurseryPondRepository
    {
        public NurseryPondRepository( ShrimpPondDbContext shrimpPondDbContext) : base(shrimpPondDbContext)
        {
        }
    }
